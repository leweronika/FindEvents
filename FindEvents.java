...
public class FindEvents {
 ...
 public static Map < Double, List < Double >> BFS(Vertex s, Map < String, List < Double >> event, int xInput, int yInput, Vertex[] vertex, LinkedList < Vertex > [] Adj, Graph eventG, int numberOfEvents) {
   ...
   //ticket as values
   Map < Double, List < Double >> cheapestTicket = new HashMap < Double, List < Double >> ();
   ...
   Map < Double, List < Double >> treeMap = new TreeMap < Double, List < Double >> (cheapestTicket);
 ...
 public static void main(String[] args) {
   ...
   Map < String, List < Double >> eventInfo = new HashMap < String, List < Double >> ();
